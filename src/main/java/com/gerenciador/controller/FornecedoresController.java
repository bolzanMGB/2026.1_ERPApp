...
public class FornecedoresController implements Initializable {
    ...
    @FXML private TableColumn<Fornecedor, String> colId, colNome, colTipo, colDocumento, colTelefone, colTelefone2, colCidade;
    ...
    private void configurarAtalhosTeclado() {
        pane.setOnKeyPressed(event -> {
            switch (event.getCode()) {
                ...
                case ESCAPE: if (fornecedorEmEdicao != null) ativarModoCadastro(); break;
                default: break;
            }
        });
    }
    ...
    public void atualizarFiltros() {
        ...
        listaFiltrada.setPredicate(fornecedor -> {
            ...
            if (selecaoTipo.equals("Pessoa Física")) matchesTipo = (fornecedor instanceof FornecedorPF);
            else if (selecaoTipo.equals("Pessoa Jurídica")) matchesTipo = (fornecedor instanceof FornecedorPJ);
            ...
            return fornecedor.getNomePrincipal().toLowerCase().contains(termoBusca) ||
                    ...
                    (pessoa.getTelefone2() != null && pessoa.getTelefone2().toLowerCase().contains(termoBusca)) ||
    ...
    public void configurarTabela() {
        ...
        colCidade.setCellValueFactory(cellData -> {
            ...
            if (f != null && f.getEndereco() != null) return new SimpleStringProperty(f.getEndereco().getCidade());
    ...
    public void editarFornecedor(Fornecedor fornecedor) {
        ...
        txtTelefone2.setText(pessoa.getTelefone2() != null ? pessoa.getTelefone2() : "");
        txtObservacao.setText(pessoa.getObservacao() != null ? pessoa.getObservacao() : "");
    ...
    public void cadastrar() {
        try {
            ...
            if (fornecedorEmEdicao == null) {
                ...
                if (isPF) {
                    DadosRepositorio.adicionarFornecedor(new FornecedorPF(txtNomePF.getText(), txtCpf.getText(), txtTelefone.getText(), txtTelefone2.getText(), txtObservacao.getText(), endereco));
                } else {
                    DadosRepositorio.adicionarFornecedor(new FornecedorPJ(txtNomeFantasia.getText(), txtTelefone.getText(), txtTelefone2.getText(), txtObservacao.getText(), endereco, txtCnpj.getText(), txtNomeResponsavel.getText(), txtInscricaoEstadual.getText(), txtRazaoSocial.getText()));
                }
                limparInputs();
                mostrarSucesso("Cadastro realizado");

            } else {
                if (fornecedorEmEdicao instanceof FornecedorPF pf) {
                ...
                } else if (fornecedorEmEdicao instanceof FornecedorPJ pj) {
